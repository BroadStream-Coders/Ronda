...
## [RM-022] Colector Cálculo Mental
- **Objetivo:** portar el colector a `catalog/calculo-mental/`. Sin imágenes ni pestañas.
- **Hecho cuando:** funciona dentro de un programa (editar + guardar/cargar json) y es asignable.
- **Fecha:** 2026-08-10 · **Estado:** Abierto

## [RM-023] Colector Sí o No
- **Objetivo:** portar el colector a `catalog/si-o-no/`. Sin imágenes ni pestañas.
- **Hecho cuando:** funciona dentro de un programa (editar + guardar/cargar json) y es asignable.
- **Fecha:** 2026-08-10 · **Estado:** Abierto
